...
import ManagePropertiesPage from "./pages/property/manage-properties-page/index";
      ...
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route exact path="/:province/:city" element={<CityPage />}>
            <Route path="/:province/:city/:community/:property" element={<Modal />}></Route>
          </Route>
          <Route exact path="/list-a-property" element={<ListAPropertyPage />}></Route>
          <Route exact path="/manage-properties" element={<ManagePropertiesPage />}>
            <Route
              exact
